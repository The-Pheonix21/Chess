...
public class Chess1 extends JFrame implements MouseListener, MouseMotionListener{
    ...
    public void mousePressed(MouseEvent e)
    {
            ...
            if (c instanceof JPanel || board.getPiece(oldpos).team() == turn)
             return;
            System.out.println(board.getPiece(oldpos).team());
    ...
    public void mouseReleased(MouseEvent me) {
        ...
        if(pm.size()==0){
            System.out.println("pos pos fail");           
        }
        Position newpos = peanut(me.getX(), me.getY());
